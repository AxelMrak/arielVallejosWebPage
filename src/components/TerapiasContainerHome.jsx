...
const terapiasHome = [
	{
		title: "Quiropraxia",
		description:
			"Esta es una profesión muy eficaz en el campo de la salud en general. Los quiroprácticos realizamos ajustes (manipulaciones) de la columna vertebral u otras partes del cuerpo.",
		img: "https://mejorconsalud.as.com/wp-content/uploads/2021/03/quiropraxia-columna-vertebral.jpg",
	},
	{
		title: "Acupuntura",
		description:
			"Se utiliza esta terapia para aliviar las molestias asociadas con distintas enfermedades y trastornos. Entre ellos náuseas y vómitos inducidos por Quimioterapia ,dolores, fibromialgia, trastorno de ansiedad, etc.",
	...
	},
	{
		...
		description:
			"Es una antiguo instrumento de corugia de forma redondeada de vidrio ó de metal, que se aplica en diversos puntos de la superficie del cuerpo para atraer a ello un aflujo de los líquidos mediante el vacío que se forma por la ventosa.",
