    ...
    <div id="carouselExampleDark" className="carousel carousel-dark slide" data-bs-ride="carousel" style={{ maxWidth: '400px' }}>
      <div className="carousel-inner">
        <div className="carousel-item active">
          <img src={gif1} class="d-block w-80" alt="..." height='400px'/>
        </div>
        <div className="carousel-item">
          <img src={gif2} class="d-block w-80" alt="..." height='400px' />
        </div>
        <div className="carousel-item">
          <img src={gif3} class="d-block w-80" alt="..." height='400px' />
        </div>
        <div className="carousel-item">
          <img src={gif4} class="d-block w-80" alt="..." height='400px' />
        </div>
        <div className="carousel-item">
          <img src={gif5} class="d-block w-80" alt="..." width='320px' height='400px' />
        </div>
        <div className="carousel-item">
          <img src={gif6} class="d-block w-80" alt="..." width='320px' height='400px' />
        </div>
        <div className="carousel-item">
          <img src={mainImage} class="d-block w-80" alt="..." height='400px' />
        </div>
      </div>
